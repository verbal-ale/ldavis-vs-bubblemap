    ...
    function visualize(data) {
        ...
        points.append("circle")
            ...
            .on("click", function(d) {
                ...
                vis_state.topic = d.topics; // used to be document.getElementById(topicID).value = vis_state.topic = d.topics;
        ...
        var title = chart.append("text")
            ...
            .style("text-anchor", "middle")
            .style("font-size", "16px")
            .text("Top-" + R + " Most Important Terms in the Collection ");
        ...
        if (params.length > 1) {
            ...
            if (!isNaN(vis_state.topic) && document.getElementById(topicID)!= null) {
                document.getElementById(topicID).value = vis_state.topic;
        ...
        function state_reset() {
            ...
            vis_state.term = "";
            vis_state.topic = 0; // used to be document.getElementById(topicID).value = vis_state.topic = 0;
            state_save(true);
        }
