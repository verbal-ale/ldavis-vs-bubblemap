...
var LDAvis = function(to_select, data_or_file_name, color1, color2) {
    ...
    function visualize(data) {
        ...
        var fakeLabelsCoords = mdsplot.selectAll("points")
            .data(mdsData)
            .enter();

        fakeLabelsCoords.append("text")
            .attr("class", "fake_txt")
            .attr("x", function(d) {
                return (xScale(+d.x));
            })
            ...
            .style("fontWeight", 100)
            .text(function(d) {
                return fakeLabelArray[d.topics-1];
            });
        ...
        svg.append("text")
            .text("Intertopic Distance Map ") // removed " (via multidimensional scaling)"
        ...
        function topic_on(circle) {
            ...
            d3.select("#" + barFreqsID)
                ...
                .style("text-anchor", "middle")
                .style("font-size", "16px")
                .text("Top-" + R + " Most Relevant Terms for Selected Topic " + " (" + Freq + "% of vocabulary)");
